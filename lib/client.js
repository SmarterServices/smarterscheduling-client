...
class Client {
  ...
  _send(url, method, authorizationToken, payload) {
    utils.validateArguments(arguments, ['string.required', 'string.required', 'string.required']);
  ...
  _getParameters(apiName, options) {
    ...
    if (paramSchema && paramSchema.isJoi) {
      parameters.params = params;
    }

    if (querySchema && querySchema.isJoi) {
      parameters.query = query;
    }

    if (payloadSchema && payloadSchema.isJoi) {
   ...
   * @returns {Promise<Object>} - Required account data
   */
  getAccount(options) {
   ...
   * @returns {Promise<Object>} - Required location data
   */
  getLocation(options) {
   ...
   * @param {string} options.authorizationToken - Api Token to send in header
   * @params {string} options.accountSid - Account Sid
   * @params {string} [options.seatSid] - Seat Sid
   * @params {string} options.calendarSid -  Calendar Sid
   * @params {string} options.startDateTime - Start Date
   * @params {number} options.duration -  Duration of Exam
   * @params {string} [options.externalId] -  External ID
   * @params {string} [options.externalSystem] -  External System
   * @params {string} options.firstName -  The first name of the person making the reservation
   * @params {string} options.lastName -  The last name of the person making the reservation
   * @params {string} options.email -  Email
   * @params {string} [options.phone] -  Phone
   * @params {string} [options.notes] -  Notes
   * @params {string} [options.metadata] -  Metadata
   * @returns {Promise<Object>} - Added Appointment
   */
   ...
   * @param {string} options.authorizationToken - Api Token to send in header
   * @params {string} options.accountSid - Account Sid
   * @params {string} options.appointmentSid - Appointment Sid
   * @returns {Promise<Object>} - An apointment object
   */
  getAppointment(options) {
  ...
  /**
   * Patches An appointment
   * @params {Object} options - Params to request with
   * @param {string} options.host - Host name for request
   * @param {string} options.authorizationToken - Api Token to send in header
   * @params {string} options.accountSid -  Account Sid
   * @params {string} options.appointmentSid -  Appointment Sid
   * @params {string} [options.startDateTime] -  Start Date Time
   * @params {number} [options.duration] -  Duration of Exam
   * @params {string} [options.externalId] -  External ID
   * @params {string} [options.externalSystem] -  External System
   * @params {string} [options.firstName] -  First Name
   * @params {string} [options.lastName] -  Last Name
   * @params {string} [options.email] -  Email
   * @params {string} [options.phone] -  Phone
   * @params {string} [options.notes] -  Notes
   * @params {object} [options.metadata] -  Metadata
   * @params {string} [options.internalNotes] -  Internal Notes
   * @params {string} [options.status] -  Status
   * @params {string} [options.statusMemo] -  Status Memo
   * @returns {Promise<Object>} - Updated Appointment
   */
  patchAppointment(options) {
  ...
  /**
   * Returns list of appointments between two date
   * @params {Object} options - Params to request with
   * @param {string} options.host - Host name for request
   * @param {string} options.authorizationToken - Api Token to send in header
   * @params {string} options.accountSid - Account Sid
   * @params {string} options.startDate - Start Date to start list
   * @params {string} options.endDate - End Date
   * @params {number} [options.calendarSid] - CalendarSid to filter with
   * @params {number} [options.locationSid] - LocationSid to filter with
   * @returns {Promise<Object>} - List of Appointments
   */
  listAppointment(options) {
